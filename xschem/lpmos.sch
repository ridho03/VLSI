...
N 180 110 180 140 {lab=vdd}
N 140 140 180 140 {lab=vdd}
N 110 140 140 140 {lab=vdd}
N 110 110 110 140 {lab=vdd}
N 110 110 140 110 {lab=vdd}
N 140 80 180 80 {lab=vdd}
N 180 80 180 110 {lab=vdd}
N 290 90 330 90 {lab=vdd}
N 330 90 330 120 {lab=vdd}
N 330 120 330 150 {lab=vdd}
N 290 150 330 150 {lab=vdd}
N 270 150 290 150 {lab=vdd}
N 270 120 270 150 {lab=vdd}
N 270 120 290 120 {lab=vdd}
N 160 260 160 290 {lab=d6}
N 120 290 160 290 {lab=d6}
N 90 290 120 290 {lab=d6}
N 90 260 90 290 {lab=d6}
N 90 260 120 260 {lab=d6}
N 120 230 160 230 {lab=d6}
N 160 230 160 260 {lab=d6}
N 270 240 310 240 {lab=vdd}
N 310 240 310 270 {lab=vdd}
N 310 270 310 300 {lab=vdd}
N 270 300 310 300 {lab=vdd}
...
C {sky130_fd_pr/pfet_01v8.sym} 160 110 0 1 {name=M1
L=0.5
W=1
nf=1
mult=4
...
C {sky130_fd_pr/pfet_01v8.sym} 310 120 0 1 {name=M2
L=0.5
W=1
nf=1
mult=4
...
C {devices/lab_pin.sym} 180 80 2 0 {name=p6 sig_type=std_logic lab=vdd}
C {devices/lab_pin.sym} 330 90 2 0 {name=p7 sig_type=std_logic lab=vdd}
...
C {devices/lab_pin.sym} 310 240 2 0 {name=p9 sig_type=std_logic lab=d7}
